...
𝙲𝙷 𖣲. :[source hacker 𖡶 ](https://t.me/SouRce_Sonic)
]]
end
...
⌔︙كلب بلدي
 — — — — — — — — —
𝙳𝙴𝚅 𖡇 : [Alamy 𖡼](https://t.me/Alamy3)
𝙲𝙷 𖣲. :[source hacker𖡶 ](https://t.me/SouRce_Sonic)
]]
end
...
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[انت مكانك كل مكان يا مطور♕](https://t.me/SouRce_hacke) ")
elseif msg.Creator then 
