...
return '𖤐 اصدار سورس FlassTas10 : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'𖤐 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سندريلا يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
if not msg.SudoBase and not redis:get(black..'lock_brod') then return "𖤐  الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(black..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "𖤐 حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end
...
return [[
╭• 𖤐 𝑆 𝑂 𝑈 𝑅 𝐶 𝐸  𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺 𖤐 •╮
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
╭• [𝑆 𝑂 𝑈 𝑅 𝐶 𝐸  𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺 ](http://t.me/FlassTas1010) •╮
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆
╭•𖤐 𝑆 𝑂 𝑈 𝑅 𝐶 𝐸  𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺 𖤐 •╮
]]
end
