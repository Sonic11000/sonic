...
return '𖤐 اصدار سورس فلسطس : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'𖤐 ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فلسطس يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : FlassTas10](https://t.me/FlassTas10)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "برامج السورس" and msg.type == "pv" then
local inline = {{{text="-فلسطس اضـغـط هـنـآ ",url="https://t.me/FlassTas10"}}}
send_key(msg.sender_user_id_,'   [مبرامج فلسطس](https://t.me/FlassTas10)' ,nil,inline,msg.id_)
return false
end
...
܁𖠐︙ التكرار
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
 مبرامج السورس ➣ @FlassTas10
 قناه المبرامج ➣ @FlassTas1010
 ↺⋆ ⋆ ⋆  ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
 ⋆ يُـوزر المّـطور ⇽{ ]]..SUDO_USER..[[ } ✓ ]]
...
܁𖠐︙الشروحات فلسطس(العالمي الصغنن) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
܁𖠐︙مبرامج السورس
 @FlassTas10
...
if not msg.SudoBase and not redis:get(hack..'lock_brod') then return "❍  الاذاعه مقفوله من قبل المطور الاساسي ." end
redis:setex(hack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "❍ حسننا الان ارسل الكليشه للاذاعه بالتثبيت  \n ♥" 
end
if redis:get(hack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(hack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(hack..'group:ids')
if #groups >= 300 then
...
return [[
╭• [𖤐𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺𖤐](http://t.me/FlassTas10) •╮
]]
end
...
elseif Text== "سام" or Text== "ساموري" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس فلسطس 𖠲](https://t.me/XxxMalificentxxX)")
elseif Text== "سورس فلسطس" or Text== "سورس فلسطس" then return  sendMsg(msg.chat_id_,msg.id_,"[افجر سورس مصري  𖠲](https://t.me/FlassTas10)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت مطوري الغالي ♕](https://t.me/FlassTas10) ")
...
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو هنا 𖦹](https://t.me/FlassTas10)")
end 
end 
