...
if MsgText[1] == "قائمه العام" or MsgText[1]=="قائمه العام⚰️" then 
if not msg.SudoUser then return"⸙ **هذا الامر يخص {المطور} فقط  \n" end
...
if MsgText[1] == 'نسخه احتياطيه للمجموعات💎️' then
if not msg.SudoBase then return"⸙ *│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
return buck_up_groups(msg)
end 
...
local inline = {{{text="-قناه السورس🚸 اضـغـط هـنـآ ",url="https://t.me/SouRce_Sonic"}}}
send_key(msg.sender_user_id_,'   [قناه السورس🚸 : سونيك](https://t.me/SouRce_Sonic)' ,nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "مطور السورس⚜️" and msg.type == "pv" then
...
if MsgText[1]== 'الردود العامه' or MsgText[1]=='الردود العامه🗣️' then
...
if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت🖌️' then
if not msg.SudoBase then return"⸙ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
...
if MsgText[1] == "تغيير الاشتراك الاجباري" or MsgText[1] == "تغيير الاشتراك الاجباري↪️" then
if not msg.SudoBase then return"⸙ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:setex(hack..":ForceSub:"..msg.sender_user_id_,350,true)
return "⸙ مرحبا بـك في نظام الاشتراك الاجباري\n⸙ الان ارسل معرف قـنـاتـك"
end
...
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الهكرℹ️ℹ️ سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الهكرℹ️ℹ️')
end
end
