...
return '◐ اصدار سورس المطور : *v'..version..'* \n'
end
...
if MsgText[1] == "الاوامر القديمه" then
if not msg.Admin then return "↺ **هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n↺ " end
return [[
‌‌‏‌‌‏‌‏    ‌‌‏‌‌‏‌‌‌‌‏                                    
...
local keyboard = {}
keyboard.inline_keyboard = {
{{text = '- مبرمج السورس 𓆩💗𓆪 .',url="https://t.me/UU_dev"},
{text = '- مبرمج السورس 𓆩💗𓆪 .',url="https://t.me/UU_Fs"}},
{{text = '- مبرمج السورس 𓆩💗𓆪 .',url="https://t.me/MOHAMED_SHEKO"}},
{{text = '- قناة السورس 𓆩💗𓆪 .',url="https://t.me/SourceHacker"},
{text = '- قناة البرمجه 𓆩💗𓆪 .',url="https://t.me/FlassTas10"}},
}   
send_inline(msg.chat_id_,  "𝚂𝙾𝚄𝚁𝙲𝙴 𓆩𝙷𝙰𝙺𝙴𝚁𓆪 ./n⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼" ,keyboard,'html')
end
...
elseif Text== "شيكو" or Text== "شيكو العالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس المطور ❀](https://t.me/OHAMED_SHEKO)")
elseif Text== "العالمي الصغنن" or Text== "عالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور جميع السورسات 𖠲](https://t.me/UU_Fs)")
elseif Text== "مروان" or Text== "جوست" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس المطور 𖠲](https://t.me/UU_DEV)")
elseif Text== "المطور" or Text== "سورس المطور" then return  sendMsg(msg.chat_id_,msg.id_,"[افجر سورس مصري  𖠲](https://t.me/SourceHacker)")
