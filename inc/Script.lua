...
local inline = {{{text="-الهكر اضـغـط هـنـآ ",url="https://t.me/FlassTas"}}}
send_key(msg.sender_user_id_,'   [مبرامج الهكر](https://t.me/FlassTas)' ,nil,inline,msg.id_)
return false
end
...
return [[
╭• [𖤐𝑯𝑨𝑪𝑲𝑬𝑹𖤐](http://t.me/SourceHacker) •╮
]]
end
...
elseif Text== "العالمي الصغنن" or Text== "عالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور جميع السورسات 𖠲](https://t.me/FlassTas)")
