...
if MsgText[1]== "مطور العالمي" and msg.type == "pv" then
local inline = {{{text="-المطور آلسـورس اضـغـط هـنـآ ",url="https://t.me/Alamy3"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/Alamy3)' ,nil,inline,msg.id_)
return false
end

if MsgText[1]== "مطور علام" and msg.type == "pv" then
local inline = {{{text="-المطور آلسـورس اضـغـط هـنـآ ",url="https://t.me/M_A_L_L_A_M"}}}
send_key(msg.sender_user_id_,'   [مطور السورس](https://t.me/M_A_L_L_A_M)' ,nil,inline,msg.id_)
return false
end
...
‌‌‏‌‌‏‌‏    ‌‌‏‌‌‏‌‌‌‌‏                                    
 ...
 ⌁م6 ⇽ اوامر التعَطيل و التفَعيل .
   ...
   ⌁م8 ⇽  اوامـر التسليـه الجديده
   ⌁م9 ⇽  اوامـر قفل الجديده
...
return [[
⸙ قائمة الأفلام إِختَر نوعية الفيلم ⸙
— — — — — — — — —
⸙-اجنبي
...
𝐸𝑁𝐽𝑂𝑌🍿
— — — — — — — — —
༄𝐶ℎ : [source sonic𖡶 ](https://t.me/SouRce_Sonic)
༄𝐶ℎ : [source hacker𖡶 ](https://t.me/SouRce_hacker)
]]
end
...
𝙲𝙷 𖣲. :[source 𖡶 ](https://t.me/FlassTas6)
...
𝙳𝙴𝚅 𖡇 : [𝙰𝙻𝙰𝙼𝚈 𖡼](https://t.me/Alamy3)
𝙳𝙴𝚅 𖡇 : [𝙰𝙻𝙻𝙰𝙼 𖡼](https://t.me/M_A_L_L_A_M)
𝙲𝙷 𖣲. :[source hacker1𖡶 ](https://t.me/FlassTas6)
...
if Black == 'welcome on' or Black == 'تفعيل محن' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل محن سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل محن')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل محن' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل محن سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل محن')
end
if Black == 'welcome on' or Black == 'تفعيل تعريص' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل تعريص سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل تعريص')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تعريص' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تعريص سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تعريص')
end
if Black == 'welcome on' or Black == 'تفعيل حب' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل حب سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل حب')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل حب' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل حب سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل حب')
end
if Black == 'welcome on' or Black == 'تفعيل زواج' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل زواج سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل زواج')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل زواج' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل زواج سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل زواج')
end
if Black == 'welcome on' or Black == 'تفعيل البوس' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل البوس سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل البوس')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل البوس' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل البوس سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل البوس')
end
if Black == 'welcome on' or Black == 'تفعيل الحوضن' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الحوضن سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الحوضن')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الحوضن' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الحوضن سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الحوضن')
end

if Black == 'welcome on' or Black == 'تفعيل مركوب' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل مركوب سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل مركوب')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل مركوب' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل مركوب سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل مركوب')
end
if Black == 'welcome on' or Black == 'تفعيل النكد' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل النكد سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل النكد')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل النكد' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل النكد سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل النكد')
end
if Black == 'welcome on' or Black == 'تفعيل اكرهني' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل اكرهني سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل اكرهني')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل اكرهني' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل اكرهني سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل اكرهني')
end
if Black == 'welcome on' or Black == 'تفعيل شاذ' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل شاذ سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل شاذ')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل شاذ' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل شاذ سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل شاذ')
end
if Black == 'welcome on' or Black == 'تفعيل عره' then
if redis:get(hack..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل عره سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل عره')
redis:set(hack..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل عره' then
if redis:get(hack..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل عره سابقا')
redis:set(hack..'welc'..msg.chat_id_,'off')
redis:del(hack..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل عره')
end
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "اللي بالي بالك"  then return sendMsg(msg.chat_id_,msg.id_,"[اللي بالي بالك  👀🔥](https://t.me/FlassTas6/2")
  elseif Text== "زنزانة7"  then return sendMsg(msg.chat_id_,msg.id_," [ زنزانة 7 👀🔥](https://t.me/FlassTas6/4)")
  elseif Text== "اللمبي 8 جيجا"  then return sendMsg(msg.chat_id_,msg.id_,"[اللمبي 8 جيجا  👀🔥](https://t.me/FlassTas6/3)")
  elseif Text== "بوحة"  then return sendMsg(msg.chat_id_,msg.id_,"[ بوحة  👀🔥](https://t.me/FlassTas6/5)")
  elseif Text== "كركر"  then return sendMsg(msg.chat_id_,msg.id_,"[  كركر  👀🔥](https://t.me/https://t.me/FlassTas6/6).")
  elseif Text== "تك تك بوم"  then  return sendMsg(msg.chat_id_,msg.id_,"[ تك تك بوم  👀🔥](https://t.me/https://t.me/FlassTas6/7)."  )
  elseif Text== "يوم ايه يوم لاء"  then return sendMsg(msg.chat_id_,msg.id_,"[ يوم ايه يوم لاء  👀🔥](https://t.me/FlassTas6/8) .")
  ...
  elseif Text== "هيه"  then return sendMsg(msg.chat_id_,msg.id_,"وبعدين" )
    elseif Text== "يوم العرض"  then return sendMsg(msg.chat_id_,msg.id_,"[يوم العرض  👀🔥](https://t.me/FlassTas6/9).")
  elseif Text== "عوكل"  then return sendMsg(msg.chat_id_,msg.id_," [ عوكل  👀🔥](https://t.me/FlassTas6/10)  ")
  elseif Text== "ندا" then return sendMsg(msg.chat_,msg.id_," [ بيست ماندو وبس↯](https://t.me/Nadaaaa7/)")
  elseif Text== "كلب بلدي"  then return sendMsg(msg.chat_id_,msg.id_,"[ كلب بلدي  👀🔥](https://t.me/FlassTas6/11)")
  elseif Text== "Vanguard"  then return sendMsg(msg.chat_id_,msg.id_,"[Vanguard  👀🔥](https://t.me/FlassTas6/13)")
  elseif Text== "Moments in Spacetime"  then return sendMsg(msg.chat_id_,msg.id_,"[Moments in Spacetime   👀🔥](https://t.me/FlassTas6/14).")
  elseif Text== "Dead Reckoning"  then  return sendMsg(msg.chat_id_,msg.id_,"[Dead Reckoning  👀🔥](https://t.me/FlassTas6/15)." )
  elseif Text== "The New Mutants"  then return sendMsg(msg.chat_id_,msg.id_,"[The New Mutants  👀🔥](https://t.me/FlassTas6/16) .")
  ...
  elseif Text== "Echo Boomers"  then return sendMsg(msg.chat_id_,msg.id_,"[Echo Boomers  👀🔥](https://t.me/FlassTas6/17)")
  elseif Text== "Chick Fight"  then return sendMsg(msg.chat_id_,msg.id_," [Chick Fight  👀🔥](https://t.me/FlassTas6/18) ")
  elseif Text== "Jingle Jangle"  then return sendMsg(msg.chat_id_,msg.id_,"[Jingle Jangle  👀🔥](https://t.me/FlassTas6/19)")
  elseif Text== "Come Away"  then return sendMsg(msg.chat_id_,msg.id_,"[ Come Away  👀🔥](https://t.me/FlassTas6/20)")
  elseif Text== "Death Files"  then return sendMsg(msg.chat_id_,msg.id_,"[Death Files  👀🔥](https://t.me/FlassTas6/21).")
  elseif Text== "The Retreat"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Retreat  👀🔥](https://t.me/FlassTas6/22)." )
  elseif Text== "cars 1"  then  return sendMsg(msg.chat_id_,msg.id_,"[cars 1  👀🔥](https://t.me/FlassTas6/23)." )
  elseif Text== "cars 2"  then  return sendMsg(msg.chat_id_,msg.id_,"[cars 2  👀🔥](https://t.me/FlassTas6/24)." )
  elseif Text== "cars 3"  then  return sendMsg(msg.chat_id_,msg.id_,"[cars 3  👀🔥](https://t.me/FlassTas6/25)." )
  elseif Text== "Ice Age 1"  then  return sendMsg(msg.chat_id_,msg.id_,"[Ice Age 1  👀🔥](https://t.me/FlassTas6/26)."  )
  elseif Text== "Ice Age 2"  then  return sendMsg(msg.chat_id_,msg.id_,"[Ice Age 2  👀🔥](https://t.me/FlassTas6/27)."  )
  elseif Text== "Ice Age 3"  then  return sendMsg(msg.chat_id_,msg.id_,"[Ice Age 3  👀🔥](https://t.me/FlassTas6/28)."  )
  elseif Text== "Ice Age 4"  then  return sendMsg(msg.chat_id_,msg.id_,"[Ice Age 4  👀🔥](https://t.me/FlassTas6/29)."  )
  elseif Text== "Ice Age 5"  then  return sendMsg(msg.chat_id_,msg.id_,"[Ice Age 5  👀🔥](https://t.me/FlassTas6/30)."  )
  elseif Text== "The Smurfs1"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Smurfs1  👀🔥](https://t.me/FlassTas6/31)."  )
  elseif Text== "The Smurfs2"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Smurfs2  👀🔥](https://t.me/FlassTas6/32)."  )
  elseif Text== "المحدودة شركة المرعبين المحدودة"  then  return sendMsg(msg.chat_id_,msg.id_,"[المحدودة شركة المرعبين المحدودة  👀🔥](https://t.me/FlassTas6/33)."  )
  elseif Text== "Toystory 4"  then  return sendMsg(msg.chat_id_,msg.id_,"[Toy_story_4  👀🔥](https://t.me/FlassTas6/34)."  )
  elseif Text== "Ralph breaks the internet"  then  return sendMsg(msg.chat_id_,msg.id_,"[Ralph breaks the internet  👀🔥](https://t.me/FlassTas6/35)."  )
  elseif Text== "Pirates of the Caribbean"  then  return sendMsg(msg.chat_id_,msg.id_,"[Pirates of the Caribbean  👀🔥](https://t.me/FlassTas6/36)."  )
  elseif Text== "Dolphin Reef"  then  return sendMsg(msg.chat_id_,msg.id_,"[Dolphin Reef  👀🔥](https://t.me/FlassTas6/37)."  )
  elseif Text== "Rampage"  then  return sendMsg(msg.chat_id_,msg.id_,"[Rampage  👀🔥](https://t.me/FlassTas6/38)."  )
  elseif Text== "kung fu panda 3"  then  return sendMsg(msg.chat_id_,msg.id_,"[kung fu panda 3  👀🔥](https://t.me/FlassTas6/39)."  )
  elseif Text== "walle"  then  return sendMsg(msg.chat_id_,msg.id_,"[walle  👀🔥](https://t.me/FlassTas6/40)."  )
  elseif Text== "Harry Potter1"  then  return sendMsg(msg.chat_id_,msg.id_,"[Harry Potter1  👀🔥](https://t.me/FlassTas6/42)."  )
  elseif Text== "Harry Potter2"  then  return sendMsg(msg.chat_id_,msg.id_,"[Harry Potter2  👀🔥](https://t.me/FlassTas6/43)."  )
  elseif Text== "Harry Potter3"  then  return sendMsg(msg.chat_id_,msg.id_,"[Harry Potter3  👀🔥](https://t.me/FlassTas6/44)."  )
  elseif Text== "Harry Potter4"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Retreat4  👀🔥](https://t.me/FlassTas6/45)."  )
  elseif Text== "Harry Potter5"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Retreat5  👀🔥](https://t.me/FlassTas6/46)."  )
  elseif Text== "Harry Potter6"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Retreat6  👀🔥](https://t.me/FlassTas6/47)."  )
  elseif Text== "Harry Potter7"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Retreat7  👀🔥](https://t.me/FlassTas6/48)."  )
  elseif Text== "Harry Potter8"  then  return sendMsg(msg.chat_id_,msg.id_,"[The Retreat8 👀🔥](https://t.me/FlassTas6/49)."  )
  elseif Text== "How to Train Your Dragon1"  then  return sendMsg(msg.chat_id_,msg.id_,"[How to Train Your Dragon1  👀🔥](https://t.me/FlassTas6/51)."  )
  elseif Text== "How to Train Your Dragon2"  then  return sendMsg(msg.chat_id_,msg.id_,"[How to Train Your Dragon2  👀🔥](https://t.me/FlassTas6/52)."  )
  elseif Text== "How to Train Your Dragon3"  then  return sendMsg(msg.chat_id_,msg.id_,"[How to Train Your Dragon3  👀🔥](https://t.me/FlassTas6/53)."  )
  elseif Text== "Spider-Man1"  then  return sendMsg(msg.chat_id_,msg.id_,"[Spider-Man1  👀🔥](https://t.me/FlassTas6/54)."  )
  elseif Text== "Spider-Man2"  then  return sendMsg(msg.chat_id_,msg.id_,"[Spider-Man2  👀🔥](https://t.me/FlassTas6/55)."  )
  elseif Text== "Spider-Man3"  then  return sendMsg(msg.chat_id_,msg.id_,"[Spider-Man3  👀🔥](https://t.me/FlassTas6/56)."  )
  elseif Text== "Spider-Man4"  then  return sendMsg(msg.chat_id_,msg.id_,"[Spider-Man4  👀🔥](https://t.me/FlassTas6/57)."  )
  elseif Text== "Spider-Man5"  then  return sendMsg(msg.chat_id_,msg.id_,"[Spider-Man5  👀🔥](https://t.me/FlassTas6/58)."  )
  elseif Text== "Spider-Man6"  then  return sendMsg(msg.chat_id_,msg.id_,"[Spider-Man6  👀🔥](https://t.me/FlassTas6/59)."  )
  elseif Text== "Aquaman"  then  return sendMsg(msg.chat_id_,msg.id_,"[Aquaman  👀🔥](https://t.me/FlassTas6/61)."  )
  elseif Text== "CaptainAmerica1"  then  return sendMsg(msg.chat_id_,msg.id_,"[CaptainAmerica1  👀🔥](https://t.me/FlassTas6/62)."  )
  elseif Text== "CaptainAmerica2"  then  return sendMsg(msg.chat_id_,msg.id_,"[CaptainAmerica2  👀🔥](https://t.me/FlassTas6/63)."  )
  elseif Text== "CaptainAmerica3"  then  return sendMsg(msg.chat_id_,msg.id_,"[CaptainAmerica3 👀🔥](https://t.me/FlassTas6/64)."  )
 elseif Text== "قصاد بابك"  then  return sendMsg(msg.chat_id_,msg.id_,"[قصاد بابك 👀🔥](https://t.me/FlassTas6/66)."  )
  elseif Text== "زمن المعجزات"  then  return sendMsg(msg.chat_id_,msg.id_,"[زمن المعجزات 👀🔥](https://t.me/FlassTas6/67)."  )
  elseif Text== "خليك صاحي"  then  return sendMsg(msg.chat_id_,msg.id_,"[خليك صاحي 👀🔥](https://t.me/FlassTas6/68)."  )
  elseif Text== "ياليل"  then  return sendMsg(msg.chat_id_,msg.id_,"[ياليل 👀🔥](https://t.me/FlassTas6/69)."  )
  elseif Text== "مبقتش اخاف"  then  return sendMsg(msg.chat_id_,msg.id_,"[مبقتش اخاف 👀🔥](https://t.me/FlassTas6/70)."  )
  elseif Text== "كان في طفل"  then  return sendMsg(msg.chat_id_,msg.id_,"[كان في طفل 👀🔥](https://t.me/FlassTas6/71)."  )
  elseif Text== "قولي"  then  return sendMsg(msg.chat_id_,msg.id_,"[قولي 👀🔥](https://t.me/FlassTas6/72)."  )
  elseif Text== "تتجوزيني"  then  return sendMsg(msg.chat_id_,msg.id_,"[تتجوزيني 👀🔥](https://t.me/FlassTas6/73)."  )
  elseif Text== "مش شرط"  then  return sendMsg(msg.chat_id_,msg.id_,"[مش شرط 👀🔥](https://t.me/FlassTas6/74)."  )
  elseif Text== "كانسر"  then  return sendMsg(msg.chat_id_,msg.id_,"[كانسر 👀🔥](https://t.me/FlassTas6/75)."  )
  elseif Text== "لو يسالوكي"  then  return sendMsg(msg.chat_id_,msg.id_,"[لو يسالوكي 👀🔥](https://t.me/FlassTas6/76)."  )
  elseif Text== "متزعليش"  then  return sendMsg(msg.chat_id_,msg.id_,"[متزعليش 👀🔥](https://t.me/FlassTas6/77)."  )
  elseif Text== "صحبي"  then  return sendMsg(msg.chat_id_,msg.id_,"[صحبي 👀🔥](https://t.me/FlassTas6/79)."  )
  elseif Text== "بارات"  then  return sendMsg(msg.chat_id_,msg.id_,"[بارات 👀🔥](https://t.me/FlassTas6/80)."  )
  elseif Text== "مقصوره"  then  return sendMsg(msg.chat_id_,msg.id_,"[مقصوره 👀🔥](https://t.me/FlassTas6/81)."  )
  elseif Text== "عسليه"  then  return sendMsg(msg.chat_id_,msg.id_,"[عسليه 👀🔥](https://t.me/FlassTas6/82)."  )
  elseif Text== "انجز"  then  return sendMsg(msg.chat_id_,msg.id_,"[انجز 👀🔥](https://t.me/FlassTas6/83)."  )
  elseif Text== "اتغيرنا"  then  return sendMsg(msg.chat_id_,msg.id_,"[اتغيرنا 👀🔥](https://t.me/FlassTas6/84)."  )
  elseif Text== "غلبه"  then  return sendMsg(msg.chat_id_,msg.id_,"[غلبه 👀🔥](https://t.me/FlassTas6/85)."  )
  elseif Text== "سكو"  then  return sendMsg(msg.chat_id_,msg.id_,"[سكو 👀🔥](https://t.me/FlassTas6/86)."  )
  elseif Text== "البويرتو"  then  return sendMsg(msg.chat_id_,msg.id_,"[البويرتو 👀🔥](https://t.me/FlassTas6/87)."  )
elseif Text== "عمر"  then  return sendMsg(msg.chat_id_,msg.id_,"[عمر 👀🔥](https://t.me/FlassTas6/88)."  )
  elseif Text== "انا مش هقدر حد"  then  return sendMsg(msg.chat_id_,msg.id_,"[انا مش هقدر حد 👀🔥](https://t.me/FlassTas6/89)."  )
  elseif Text== "نافثلين"  then  return sendMsg(msg.chat_id_,msg.id_,"[نافثلين 👀🔥](https://t.me/FlassTas6/90)."  )
  elseif Text== "عظمه"  then  return sendMsg(msg.chat_id_,msg.id_,"[عظمه 👀🔥](https://t.me/FlassTas6/91)."  )
  elseif Text== "انترو"  then  return sendMsg(msg.chat_id_,msg.id_,"[انترو 👀🔥]https://t.me/FlassTas6/92)."  )
  elseif Text== "كان في دماغي وحوش"  then  return sendMsg(msg.chat_id_,msg.id_,"[كان في دماغي وحوش 👀🔥](https://t.me/FlassTas6/95)."  )
  elseif Text== "استلم يا هيثم"  then  return sendMsg(msg.chat_id_,msg.id_,"[استلم يا هيثم 👀🔥](https://t.me/FlassTas6/96)."  )
  elseif Text== "باشا اعتمد"  then  return sendMsg(msg.chat_id_,msg.id_,"[باشا اعتمد 👀🔥](https://t.me/FlassTas6/97)."  )
  elseif Text== "فوقني"  then  return sendMsg(msg.chat_id_,msg.id_,"[فوقني 👀🔥](https://t.me/FlassTas6/98)."  )
  elseif Text== "نا نا نا"  then  return sendMsg(msg.chat_id_,msg.id_,"[نا نا نا 👀🔥](https://t.me/FlassTas6/99)."  )
  elseif Text== "مونشاكو"  then  return sendMsg(msg.chat_id_,msg.id_,"[مونشاكو 👀🔥](https://t.me/FlassTas6/100)."  )
  elseif Text== "سيستم"  then  return sendMsg(msg.chat_id_,msg.id_,"[سيستم 👀🔥](https://t.me/FlassTas6/101)."  )
  elseif Text== "الجميزه"  then  return sendMsg(msg.chat_id_,msg.id_,"[الجميزه 👀🔥](https://t.me/FlassTas6/102)."  )
  elseif Text== "ديناميت"  then  return sendMsg(msg.chat_id_,msg.id_,"[ديناميت 👀🔥](https://t.me/FlassTas6/103)."  )
  elseif Text== "فولكلور"  then  return sendMsg(msg.chat_id_,msg.id_,"[فولكلور 👀🔥](https://t.me/FlassTas6/104)."  )
  elseif Text== "ابو مكه"  then  return sendMsg(msg.chat_id_,msg.id_,"[ابو مكه 👀🔥](https://t.me/FlassTas6/105)."  )
  elseif Text== "سندباد"  then  return sendMsg(msg.chat_id_,msg.id_,"[سندباد 👀🔥](https://t.me/FlassTas6/106)."  )
  elseif Text== "فري"  then  return sendMsg(msg.chat_id_,msg.id_,"[فري 👀🔥](https://t.me/FlassTas6/107)."  )
  elseif Text== "افتر بارتي"  then  return sendMsg(msg.chat_id_,msg.id_,"[افتر بارتي 👀🔥](https://t.me/FlassTas6/108)."  )
  elseif Text== "سكانيا"  then  return sendMsg(msg.chat_id_,msg.id_,"[سكانيا 👀🔥](https://t.me/FlassTas6/109)."  )
  elseif Text== "اتاري"  then  return sendMsg(msg.chat_id_,msg.id_,"[اتاري 👀🔥](https://t.me/FlassTas6/110)."  )
  elseif Text== "انتي بسكوتايه مقرمشه"  then  return sendMsg(msg.chat_id_,msg.id_,"[انتي بسكوتايه مقرمشه 👀🔥](https://t.me/FlassTas6/120)."  )
  elseif Text== "انتي خبيثه"  then  return sendMsg(msg.chat_id_,msg.id_,"[انتي خبيثه 👀🔥](https://t.me/FlassTas6/121)."  )
  elseif Text== "قشطة بالزبادي"  then  return sendMsg(msg.chat_id_,msg.id_,"[قشطة بالزبادي 👀🔥](https://t.me/FlassTas6/122)."  )
  elseif Text== "اخواتي الصواريخ"  then  return sendMsg(msg.chat_id_,msg.id_,"[اخواتي الصواريخ 👀🔥](https://t.me/FlassTas6/123)."  )
  elseif Text== "هشتكة"  then  return sendMsg(msg.chat_id_,msg.id_,"[هشتكة 👀🔥](https://t.me/FlassTas6/124)."  )
  elseif Text== "انتي معلمه"  then  return sendMsg(msg.chat_id_,msg.id_,"[انتي معلمه 👀🔥](https://t.me/FlassTas6/125)."  )
  elseif Text== "انتي لسه في عهدي"  then  return sendMsg(msg.chat_id_,msg.id_,"[انتي لسه في عهدي 👀🔥](https://t.me/FlassTas6/126)."  )
  elseif Text== "سالكه"  then  return sendMsg(msg.chat_id_,msg.id_,"[سالكه 👀🔥](https://t.me/FlassTas6/127)."  )
  elseif Text== "الشر جالكم 1"  then  return sendMsg(msg.chat_id_,msg.id_,"[الشر جالكم 1 👀🔥](https://t.me/FlassTas6/128)."  )
  elseif Text== "الشر جالكم 2"  then  return sendMsg(msg.chat_id_,msg.id_,"[الشر جالكم 2 👀🔥](https://t.me/FlassTas6/129)."  )
