...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/Alamy300/Googlefile/main/GetVersion.txt' ) or 0
...
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
• 𝒅𝒆𝒗 >> [˹ 𝒈𝒐𝒐𝒈𝒍𝒆.](t.me/KGTBR)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
• 𝒅𝒆𝒗 >> [˹ 𝒋𝒂𝒎𝒂𝒎.](t.me/J_R_5)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
• • >> [˹ 𝒔𝒐𝒖𝒓𝒄𝒆_𝒈𝒐𝒐𝒈𝒍𝒆𖤝.](t.me/SouRce_Google)
⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ 
...
𝙲𝙷 𖣲. :[SouRce_hacker 𖡶 ](https://t.me/SouRce_hacker)
]]
end
...
⌔︙كلب بلدي
 — — — — — — — — —
𝙳𝙴𝚅 𖡇 : [Alamy 𖡼](https://t.me/Alamy3)
𝙲𝙷 𖣲. :[SouRce_hacker𖡶 ](https://t.me/SouRce_hacker)
]]
end
...
𝙳𝙴𝚅 𖡇 : [Alamy 𖡼](https://t.me/Alamy3)
𝙲𝙷 𖣲. :[SouRce_hacker𖡶 ](https://t.me/SouRce_hacker1)
...
function WelcomeByAddUser(Google,Diamond)
...
------set cmd------
Google = msg.text 
if Google == 'رفع مشرف كامل' and msg.reply_to_message_id_ ~= 0 then

if not msg.Kara then return "⚛ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function setadmins(Google,diamond)
...
if Google == 'رفع مشرف' and msg.reply_to_message_id_ ~= 0 then
...
if Google == 'تنزيل مشرف' and msg.reply_to_message_id_ ~= 0 then

if not msg.Kara then return "⚛ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط ." end

function remadmins(Google,diamond)
...
if Google:match('تغير امر (.*)') then
if not msg.Kara then return "⚛ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Google:match('تغير امر (.*)') 
...
if Google and (Google:match('^delcmd (.*)') or Google:match('^مسح امر (.*)')) then
if not msg.Kara then return "⚛ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
local cmd = Google:match('^delcmd (.*)') or Google:match('^مسح امر (.*)')
redis:hdel(Google..'CmD:'..msg.chat_id_,cmd)
redis:srem(Google..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"⚛ اهلا عزيزي\nالامر >"..cmd.."\n⚛ تم مسحه من قائمه الاوامر\n")
end
if Google == 'مسح قائمه الاوامر' or Google == 'مسح قائمه الاوامر' then
if not msg.Kara then return "⚛ **هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n" end
...
if Google == 'welcome on' or Google == 'تفعيل الترحيب' then
if redis:get(Google..'welc'..msg.chat_id_) == 'on' then
...
elseif Text== "العالمي" or Text== "عالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس الهكر وبلاك وجوجل ⚛](https://t.me/Alamy3)")
elseif Text== "جوجل" or Text== "جوجل" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس جوجل ⚛](https://t.me/KGTBR)")
elseif Text== "جمام" or Text== "جمام الهكر" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس جوجل ⚛](https://t.me/J_R_5)")
elseif Text== "هايدي" or Text== "قلب العالمي" then return  sendMsg(msg.chat_id_,msg.id_,"[حبيبت العالمي ووبس ⚛](https://t.me/H_yah1)")
elseif Text== "سورس جوجل" or Text== "سورس جوجل" then return  sendMsg(msg.chat_id_,msg.id_,"[افضل سورس مصري ⚛](https://t.me/SouRce_Google)")
