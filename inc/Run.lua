...
▀█████████▄           ██       ████████
██▀ │FlassTas ﹏ @FlassTas
│تم تطوير وبرمجة السورس من قبل 𝙼𝙰𝙻𝙰𝙺 .
│@FlassTas
#-------------------------------------------------------------------
]]
...
elseif msg.sender_user_id_ == 1465873379 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == 1372455240 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1

elseif msg.sender_user_id_ == 1294554320 then 
msg.TheRank =  ' مطور السورس '
msg.Rank = 1
...
• قنـاة سورس سـندريـلا ⇐ @SouRce_Cinderella
