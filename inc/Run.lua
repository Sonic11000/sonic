...
▀█████████▄           ██       ████████
██▀ │FlassTas ﹏ @FlassTas
│تم تطوير وبرمجة السورس من قبل اسيبدᐂ .
│@FlassTas
#-------------------------------------------------------------------
]]
...
if msg.sender_user_id_ == 1041487390 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1

elseif msg.sender_user_id_ == 1252926014 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
