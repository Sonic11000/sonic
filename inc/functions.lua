...
var = 'مطور اساسي' 
elseif  UserID ==1174250096 then
var =  'مطور السورس'
elseif  UserID ==1417804968 then
var =  'مطور السورس'
elseif  UserID == 954727833 then
var =  'فلسطس الهكر'
elseif  UserID == 1491331094 then
var =  'مالك السورس'
elseif  UserID ==1491331094 then
var =  'مطور  السورس'
elseif  UserID == 1491331094 then
...
elseif UserID ==1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك تقييد فلسطس الهكر\n") 
elseif UserID == 954727833 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك تقييد مطور السورس\n") 
elseif UserID == 1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك تقييد مطور السورس\n") 
...
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك حظر مطور السورس\n") 
elseif UserID ==1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك حظر فلسطس الهكر\n") 
elseif UserID == 954727833 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك حظر مطور السورس\n") 
...
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك كتم مطور السورس\n")
elseif UserID ==1174250096 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك كتم فلسطس الهكر\n") 
elseif UserID == 954727833 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك كتم مطور السورس\n") 
elseif UserID == 1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك كتم مطور السورس\n") 
...
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك طرد مطور السورس\n")  
elseif UserID ==1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك طرد فلسطس الهكر\n") 
elseif UserID == 954727833 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك حظر مطور السورس\n") 
elseif UserID ==1491331094 then 
return sendMsg(ChatID,MsgID,"◐ **لا يمكنك طرد مطور السورس\n") 
